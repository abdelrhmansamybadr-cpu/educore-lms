...
const roleDashboard: Record<string, string> = {
  ...
  HR_MANAGER: '/admin/hr',
  IT_ADMIN: '/admin/it/dashboard',
  IT_MANAGER: '/admin/it/dashboard',
  IT_STAFF: '/admin/tickets',
  ...
  ACTIVITIES_COORDINATOR: '/admin/events',
  REQUISITIONS_MANAGER: '/admin/requisitions',
  CFO: '/admin/finance',
  FINANCE_MANAGER: '/admin/finance',
  SCHOOL_ACCOUNTANT: '/admin/finance',
  CASHIER: '/admin/finance/cashier',
  PAYROLL_OFFICER: '/admin/finance',
  PROCUREMENT_OFFICER: '/admin/finance',
  AUDITOR: '/admin/finance',
  BRANCH_FINANCE_ADMIN: '/admin/finance',
}
